...
public class KinematicMoverFactory : MonoBehaviour
{
    ...
    public KinematicMover Create(MovementBehavior movementBehavior, RotationBehavior rotationBehavior, GameObject target, float maxAcceleration, float maxAngularAcceleration, Kinematic character)
    {
